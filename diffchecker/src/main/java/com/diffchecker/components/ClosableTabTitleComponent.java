...
public class ClosableTabTitleComponent extends JPanel {
    public ClosableTabTitleComponent(JTabbedPane tabbedPane, String title, Runnable onTabEmptyFallback) {
        ...
        closeButton.addMouseListener(new MouseAdapter() {
            @Override public void mouseEntered(MouseEvent e) { closeButton.setIcon(hoverIcon); }
            @Override public void mouseExited(MouseEvent e) { closeButton.setIcon(defaultIcon); }
        });
